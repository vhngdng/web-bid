...
function HeaderDefault() {
    ...
    return (
        <nav className="w-screen border-gray-200 py-2.5 rounded dark:bg-gray-900 ">
            <div className="container flex  items-center justify-end mx-auto min-w-full mb-12">
                <div
                    className="hidden w-max md:block md:w-auto"
                    id="navbar-default"
                >
                    <div className="flex flex-col border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <div className="flex justify-center items-center relative m-6 inline-flex w-fit">
                            {/* <div
                                onClick={() => navigate('/')}
                                className="cursor-pointer block py-2 pl-3 pr-4 text-white rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white"
                            >
