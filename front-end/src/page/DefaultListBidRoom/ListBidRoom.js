                                    ...
                                    <div className="text-gray-700 text-sm font-light rounded-lg">
                                        {data &&
                                            ...
                                            data.content.map((bid, index) => (
                                                <motion.div
                                                    key={index}
                                                    className={`flex h-fit justify-evenly items-center w-full cursor-pointer hover:bg-gray-100 my-4
                                                        ${
                                                            (index + 1) % 2 &&
                                                            'rounded-lg'
                                                        }`}
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <div className="text-center">
                                                                    <div className="font-extrabold lg:text-6xl text-4xl text-black">
                                                                        <span>
                                                                            {
                                                                                bid
                                                                                    .property
