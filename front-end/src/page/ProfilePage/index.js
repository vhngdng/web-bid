    ...
    return (
        <>
            <div>
                ...
                <aside
                    id="default-sidebar"
                    className="fixed top-auto left-auto z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
                    aria-label="Sidebar"
                >
                    <div className="h-4/5 w-2/3 px-3 py-4 overflow-y-auto bg-gray-50/25 dark:bg-gray-800">
                        <ul className="">
                            <li>
                                <button
                                    className="flex flex-col items-center w-full bg-gray-200 ml-0 py-2 text-base font-normal text-teal-300 hover:text-black rounded-lg dark:text-white hover:bg-blue-300 dark:hover:bg-gray-700"
