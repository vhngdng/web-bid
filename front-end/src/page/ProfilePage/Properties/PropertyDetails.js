                        ...
                        <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                            <div className="flex -mx-4 flex items-center justify-between lg:justify-start lg:items-start xl:items-center">
                                <div className="w-full sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-center">
                                    ...
                                    >
                                        <img
                                            ...
                                            src="uinel-assets/images/ecommerce-product-info/pla /ceholder2.png"
                                            alt=""
                                        />
                                    </a>
                                    <a
                                    ...
                                    >
                                        <img
                                            className="h-full w-full"
                                            src="uinel-assets/images/ecommerce-product-info/pla /ceholder4.png"
                                            alt=""
                                        />
                                    </a>
                                    <a
                                    ...
                                    >
                                        <img
                                            className="h-full w-full"
                                            src="uinel-assets/images/ecommerce-product-info/pla /ceholder3.png"
                                            alt=""
                                        />
                                    </a>
                                    <a
                                ...
                                <div className="w-full sm:w-9/12 px-4">
                                    <img
                                        className="mb-5 object-fill h-96 w-96"
                                        src={bonsai}
                                        alt=""
                                    />
                        ...
                        <div className="w-full lg:w-1/2 px-4">
                            <div className="max-w-md mb-6">
                                ...
                                <p className="text-lg text-gray-400">
                                    The nulla commodo, commodo eros a lor,
                                    tristique lectus. Lorem sad 128 GB silver.
                                </p>
                            </div>
